...
namespace Tesseract.Client.Proxies
{
	public class TagsProxy : TesseractProxyBase
	{
			...
			string tagNs, string tag, PatchAccountWeightsOnTagRequest request)
		{
            ...
            return await InternalSendRequest(new HttpMethod("PATCH"), $"/api/tags/ns/{tagNs}/t/{tag}/accounts", request);
		}

		public async Task<ApiValidatedResult<PatchAccountWeightsOnTagResponse>> PatchAccountWeightsOnTagAndWait(string tagNs,
